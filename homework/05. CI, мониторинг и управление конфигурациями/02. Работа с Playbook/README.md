# Домашнее задание по теме: "Работа с Playbook"
...
3. При создании tasks рекомендую использовать модули: `get_url`, `template`, `unarchive`, `file`.
	...
	Модули `get_url`, `template`, `unarchive`, `file` использованны.

4. Tasks должны: скачать нужной версии дистрибутив, выполнить распаковку в выбранную директорию, установить vector.

	Tasks выполняют данные задачи.

5. Запустите `ansible-lint site.yml` и исправьте ошибки, если они есть.

	Ошибок нет:
	```
	/playbook(main)]>ansible-lint	
	Passed with production profile: 0 failure(s), 0 warning(s) on 10 files.
	```

6. Попробуйте запустить playbook на этом окружении с флагом `--check`.

	Результат - ошибка, т.к. rpm для установки `clickhouse` нет:
...
7. Запустите playbook на `prod.yml` окружении с флагом `--diff`. Убедитесь, что изменения на системе произведены.
    ...
    +++ after: /home/ivanm/.ansible/tmp/ansible-local-392pd7tuj6v/tmp8wh0l272/config.xml.j2
    @@ -1,722 +1,87 @@
    -<!--
    ...
    +++ after: /home/ivanm/.ansible/tmp/ansible-local-392pd7tuj6v/tmp76x51o82/users.xml.j2
    @@ -1,110 +1,31 @@
     <clickhouse>
    ...
    PLAY [Create DB & User For Vector] ****************************************************************************************************************************************
    ...
    TASK [Generate systemd unit for vector] ***********************************************************************************************************************************
    --- before
    +++ after: /home/ivanm/.ansible/tmp/ansible-local-392pd7tuj6v/tmpg7qw4mnv/vector.service.j2
    @@ -0,0 +1,18 @@
    +[Unit]
    +Description=Vector
    ...
    TASK [Rendering vector config] ********************************************************************************************************************************************
    --- before
    +++ after: /home/ivanm/.ansible/tmp/ansible-local-392pd7tuj6v/tmp4ls6jlnr/vector.yml.j2
    @@ -0,0 +1,24 @@
    ...
    +    endpoint: http://158.160.59.33:8123
    +    inputs:
    +    - logs
...
9. Подготовьте README.md файл по своему playbook. В нём должно быть описано: что делает playbook, какие у него есть параметры и теги.
	...
	[README.md](https://github.com/ivanmanokhin/clickhouse-vector-stack/blob/08-ansible-02-playbook/README.md)

10. Готовый playbook выложите в свой репозиторий, поставьте тег `08-ansible-02-playbook` на фиксирующий коммит, в ответ предоставьте ссылку на него.

	[Репозиторий](https://github.com/ivanmanokhin/clickhouse-vector-stack/blob/08-ansible-02-playbook/README.md)
